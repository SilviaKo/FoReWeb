		...
		<div class="container">
			...
			<hr/>
	      	...
	      	<div class="row">
				...
				${user.userProfile.diseases['Type2DiabetesMellitus']} |
				${user.userProfile.diseases['Type2DiabetesMellitus'] == true}
	      			<div class="panel panel-default">
	  					<div class="panel-heading">
		  				...
		  				<table class="table">
				  			<tr>
				  				...
				  				<td>
				  					<c:choose>
				  						<c:when test="${user.userProfile.diseases.CardiovascularDisease == true}">
				  			...
				  			<tr>
				  				...
				  				<td>
				  					<c:choose>
				  						<c:when test="${user.userProfile.diseases.CoronaryHeartDisease == true}">
				  							<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span>
				  						</c:when>
				  						<c:otherwise>
				  							<span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>
				  			...
				  			<tr>
				  				...
				  				<td>
				  					<c:choose>
				  						<c:when test="${user.userProfile.diseases.Type2DiabetesMellitus == true}">
				  							<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span>
				  						</c:when>
				  						<c:otherwise>
				  							<span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>
				  			...
				  			<tr>
				  				...
				  				<td>
				  					<c:choose>
				  						<c:when test="${user.userProfile.diseases.Cancer == true}">
				  							<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span>
				  						</c:when>
				  						<c:otherwise>
				  							<span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>
			...
			<h2>Erweiterte Angaben</h2>
	      	...
	      	<div class="row">
				...
				<div class="col-md-6">
		      		<div class="panel panel-default">
			  			<div class="panel-heading">
			    			<h3 class="panel-title">Genetische Veranlagungen</h3>
			  			</div>
			...
			<a href="profileEdit.htm" class="btn btn-primary">Profil bearbeiten</a>
